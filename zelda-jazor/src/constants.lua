...
DEBUG = false
DEBUG_ENTITYBOX = true
DEBUG_OBJECTBOX = true
DEBUG_PICKUP = true
DEBUG_HITBOX = true
DEBUG_TYPE = 'pots'
...
MAP_XMIN = MAP_RENDER_OFFSET_X + TILE_SIZE
MAP_XMAX = VIRTUAL_WIDTH - TILE_SIZE * 2
MAP_YMIN = MAP_RENDER_OFFSET_Y + TILE_SIZE
MAP_YMAX = VIRTUAL_HEIGHT - (VIRTUAL_HEIGHT - MAP_HEIGHT * TILE_SIZE) + MAP_RENDER_OFFSET_Y - TILE_SIZE
